...
<header class="main-header">
  <nav class="main-navigation container">
    <a class="main-header-logo" href="product.html">
...
<main class="page-product container">
  ...
  <ul class="breadcrumbs">
    <li><a href="product.php">Главная</a></li>
    <li><a href="catalog.php">Магазин</a></li>
    <li><a href="catalog.php">Средства для ухода</a></li>
    <li class="breadcrumbs-current">Набор для путешествий «Baxter of California»</li>
  </ul>

  <section class="product-photos">
    <h2 class="visually-hidden">Изображения товара</h2>
    <img class="product-photo-full" src="img\main photo.jpg" width="460" height="498" alt="Фото всего набора">
    <ul class="product-photo-preview">
      <li>
        <img src="img\photo 7.jpg" width="140" height="149" alt="анфас">
      </li>
      <li>
        <img src="img\photo 8.jpg" width="140" height="149" alt="профиль">
      </li>
      <li>
        <img src="img\photo 9.jpg" width="140" height="149" alt="Фото отдельной части">
      </li>
    </ul>
  </section>
